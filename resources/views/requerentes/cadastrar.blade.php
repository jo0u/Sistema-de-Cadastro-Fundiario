...
<div class="col"> 
<label for="">RG</label>    
<input type="text" class="form-control" aria-label="Sizing example input" id="rg" name="rg" aria-describedby="inputGroup-sizing-sm" minlength="13" maxlength="15" required></div>
    <div class="col">
   <div>
